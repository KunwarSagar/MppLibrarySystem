...
public class BothHomePage extends JFrame implements LibrarySystemWindow {

    private static final long serialVersionUID = 1L;

    public static final BothHomePage INSTANCE = new BothHomePage();
    ...
    public void constructSideBarMenu(){
        ...
        for(String item : ConstantConfig.ALL_MENU){
