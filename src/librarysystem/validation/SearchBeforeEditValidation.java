...
public class SearchBeforeEditValidation implements Validation {
    ...
    public void checkEmptyFields() throws ValidationException {
    ...
    private void nonemptyRule() throws ValidationException {
    ...
    private void zipNumericRule() throws ValidationException {
    ...
    private void stateRule() throws ValidationException {
