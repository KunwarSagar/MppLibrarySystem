    ...
    private class AddBookCopyListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) throws NumberFormatException {
            ...
            try {
                ...
                Validation searchRuleset = ValidationFactory.getValidation(AddBookCopyPanel.this);
                searchRuleset.checkValidation(AddBookCopyPanel.this);
                ...
                // update book
                ci.saveBook(book);
                new MessageBox.InnerFrame().showMessageBox(  "1 Copy added successfully ", "Info");
                clearFormFields();
